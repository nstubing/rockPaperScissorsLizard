...
namespace rockPaperScissors
{
    class Game
    {
        ...
        Player player1;
        Player player2;
        public string[] gestureOptions = { "rock", "paper", "scissors", "spock", "lizard" };
      //  public string[,] gestureOutcomes = { { "crushes", "crushes" },{ "covers", "disproves" },{ "cuts", "decapitates" },{ "disassembles", "vaporizes" },{ "poisons", "eats" } };
        public int[] calculationOptions = { 4, 0, 1, 2, 3, 4, 0, 1 };
        ...
        public void FindWinner()
        {
            ...
            if ((player1.pick==calculationOptions[player1.pick])||(player1.pick==calculationOptions[player1.pick+3]))
            {
                Console.WriteLine("Player one wins!  "+gestureOptions[player1.pick]+" beats "+gestureOptions[player2.pick]+"!");
                player1.wins += 1;
            }
            else
            {
                Console.WriteLine("Player two wins!  " + gestureOptions[player2.pick] + " beats " + gestureOptions[player1.pick]+"!");
                player2.wins += 1;
            }
        }
